...
internal static class DisplayStatusHelper
{
    ...
    public static void DisplayGCDStatus()
    {
        ...
        ImGui.Text("GCD Total: " + DataBase.DefaultGCDTotal.ToString("F2") + "s" + "\\" + DataBase.DefaultGCDRemain.ToString("F2") + "s");
        ImGui.SameLine();
        ...
        ImGui.Text("GCD Remain: " + DataBase.DefaultGCDRemain.ToString("F2"));
        ImGui.SetCursorPosX(ImGui.GetCursorPosX() + padding);
        ImGui.ProgressBar(DataBase.DefaultGCDRemain / DataBase.DefaultGCDTotal, progressBarSize, "");

        // Add some padding between the progress bars
        ImGui.Dummy(new Vector2(0, padding));

        ImGui.Text("GCD Elapsed: " + DataBase.DefaultGCDElapsed.ToString("F2"));
        ImGui.SetCursorPosX(ImGui.GetCursorPosX() + padding);
        ImGui.ProgressBar(DataBase.DefaultGCDElapsed / DataBase.DefaultGCDTotal, progressBarSize, "");
