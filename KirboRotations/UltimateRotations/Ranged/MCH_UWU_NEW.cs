...
[BetaRotation]
[Rotation("MCH UWU NEW",
    CombatType.PvE,
    GameVersion = $"v.\notation： v...1\n\n",
    Description = $"")]
[SourceCode(Path = "")]
[Api(4)]
public sealed class MCH_UWU_NEW : MachinistRotation
{
    ...
    protected override bool EmergencyAbility(IAction nextGCD, out IAction? act)
    {
        ...
        act = null;
        bool isNailSmall = CurrentTarget?.Name.ToString() == "Infernal Nail" && !Target.HasStatus(false, StatusID.VulnerabilityDown_1545);
        ...
        bool isNailBig = CurrentTarget?.Name.ToString() == "Infernal Nail" && Target.HasStatus(false, StatusID.VulnerabilityDown_1545);
        ...
        bool isTargetIfrit = CurrentTarget?.Name.ToString() == "Ifrit";
        bool isTargetGaruda = Target.Name.ToString() == "Garuda";
        bool isTargetSatinPlume = CurrentTarget?.Name.ToString() == "Satin Plume";
        ...
        if (BarrelStabilizerPvE.CanUse(out act) && CombatTime > 150)
        {
            return true;
        }
