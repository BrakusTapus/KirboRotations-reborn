...
internal unsafe class CustomRotationEx
{
    ...
    */
    ...
    private unsafe FFXIVClientStructs.FFXIV.Client.Game.RecastDetail* CoolDownDetail => ActionIdHelper.GetCoolDownDetail(CoolDownGroup);
    ...
    public unsafe ushort CurrentCharges => (ushort)FFXIVClientStructs.FFXIV.Client.Game.ActionManager.Instance()->GetCurrentCharges(BaseAction.Info.AdjustedID);

    internal float RecastTimeOneChargeRaw => FFXIVClientStructs.FFXIV.Client.Game.ActionManager.GetAdjustedRecastTime(FFXIVClientStructs.FFXIV.Client.Game.ActionType.Action, BaseAction.Info.AdjustedID) / 1000f;



    public static unsafe float GetRecastTime(FFXIVClientStructs.FFXIV.Client.Game.ActionType type, uint id)
    {
    ...
    {
        return GetRecastTime(FFXIVClientStructs.FFXIV.Client.Game.ActionType.Action, 11);
    }

    public static unsafe float GetRecastTimeElapsed(FFXIVClientStructs.FFXIV.Client.Game.ActionType type, uint id)
    {
        FFXIVClientStructs.FFXIV.Client.Game.ActionManager* actionManager = FFXIVClientStructs.FFXIV.Client.Game.ActionManager.Instance();
        if (actionManager == null)
        {
    ...
    {
        return GetRecastTimeElapsed(FFXIVClientStructs.FFXIV.Client.Game.ActionType.Action, 11);
    }
    #endregion
    ...
    */
    ...
    internal unsafe bool Use(ActionID actionID)
    {
        ...
        {
            return ActionManager.Instance()->UseActionLocation(ActionType.Action, (uint)actionID, targetObjectId, (Vector3*)&loc);
        }
