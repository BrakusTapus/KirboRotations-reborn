...
public sealed class WAR_Kirbo : WarriorRotation
{
    ...
    [RotationConfig(CombatType.PvE, Name = "Enable for experimental testing.")]
    public bool ExperimentalTest { get; set; } = false;
    ...
    protected override bool EmergencyAbility(IAction nextGCD, out IAction? act)
    {
        ...
        if (ExperimentalTest && IsLastGCD(false, StormsEyePvE) && Player.HasStatus(true, StatusID.SurgingTempest) && InnerReleasePvE.CanUse(out act))
        {
            return true;
        }
    ...
    protected override bool AttackAbility(IAction nextGCD, out IAction? act)
    {
        ...
        //if (Player.HasStatus(false, StatusID.SurgingTempest) && !Player.WillStatusEndGCD(2, 0, true, StatusID.SurgingTempest)
